<template>
  <div>
    ...
    <h4 class="pt-3">Incomings for {{ theDate }}</h4>    
      <div class="pt-2">
  ...
  ,data(){
    ...
    ,methods:{
      ...
      ,setStartingDate(date){
        ...
        this.theDate = date.toLocaleString('default', options)
      ...
      ,loadData(){
        ...
        clazz.$apiManager.getWorkedHoursReport(clazz.year, clazz.month)
        .then((response) => {            
          clazz.summaries=[]
          clazz.totalIncomings=0
            ...
            response.data.forEach(element => {
              ...
              clazz.totalIncomings += parseFloat(element.totalAmount)
              clazz.summaries.push(element)
      ...
      ,filterByDates(){
        ...
        this.setStartingDate(this.dateFilter)
